    ...
    <div className="space-y-16 pb-10" data-testid="beta-landing">
      <section className="pt-6">
        ...
        <div className="grid gap-10 pt-12 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-center">
          <div>
            <span className="inline-flex flex-wrap items-center gap-2 rounded-lg border border-[#F26440]/40 bg-[#F26440]/10 px-3 py-1.5 font-mono text-[11px] font-bold uppercase tracking-[0.14em] text-[#F6A18C]">
              <FlaskConical className="h-3.5 w-3.5" aria-hidden="true" />
              {PUBLIC_PREBETA_LABEL} · {PUBLIC_PREBETA_CODE} · {FREE_BETA_LABEL} · {FREE_BETA_PRICE_PLN} zł
            </span>
            ...
            <p className="mt-3 max-w-[52ch] text-sm font-semibold text-[#F6A18C]">
              {PUBLIC_PREBETA_MESSAGE}. Możesz już wejść, sprawdzić narzędzia i zgłaszać uwagi przed właściwą premierą.
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              >
                Zobacz zakres wersji testowej
              </button>
            </div>

            <p className="mt-4 max-w-[48ch] font-mono text-[11px] leading-relaxed text-slate-500">
              Public Pre-Beta jest bezpłatna. Bez karty i bez aktywnych zakupów. Limity funkcji AI nadal egzekwuje serwer.
            </p>
          </div>
          ...
          <aside className={`${SURFACE} p-6`} aria-label="Najważniejsze zasady bety">
            ...
            <ul className="mt-5 space-y-3 text-sm leading-relaxed text-slate-300">
              {[
                `Wersja: ${PUBLIC_PREBETA_LABEL} (${PUBLIC_PREBETA_CODE}).`,
                'Cena bety: 0 zł.',
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        ...
        <div className={`${SURFACE} p-6`}>
          ...
          <p className="mt-3 text-sm leading-relaxed text-slate-400">
            ...
            wysyła rozmowy do modelu AI. Wejście do Doradcy znajduje się w głównej nawigacji obok Porad i Audytu.
          </p>
        </div>
      </section>
